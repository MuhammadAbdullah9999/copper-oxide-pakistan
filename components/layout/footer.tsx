        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">CopperOxide Pakistan</span>
            </div>
          ...
          <div>
            ...
            <form className="space-y-2">
              ...
              />
              <Button className="w-full bg-amber-700 hover:bg-amber-800">Subscribe</Button>
            </form>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-gray-400 text-center">
          <p>&copy; {new Date().getFullYear()} CopperOxide Pakistan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
